...
} from '@/lib/hdfc-client-store';
import type { GateStatus } from '@/lib/hdfc-client-store';
...
export function HdfcWorkflowProvider({ children }: { children: ReactNode }) {
...
export function useHdfcWorkflow() {
