...
const CLIENTS = [
  ...
  },
  {
    ...
    description: 'GenAI enablement for retail asset sales leaders — Personal Loans, Auto, CV, Tractor, Home Loans, LAP, Credit Cards, Merchant Acquiring & Payment Gateway. 60+ use cases with Field Sales AI for prospect research, objection handling & deal closing.',
    tags: ['Prompt Lab', 'Doc Intelligence', 'Sales AI', 'Use Cases', 'Field Sales AI'],
    letter: 'H',
    letterBg: '#ED1C24',
    letterColor: '#ffffff',
    accentColor: '#ED1C24',
